...
const NavBar = props => {
    ...
    const { generateArray, getAnimationSpeed, isAnimating, bubbleSort, cocktailSort, heapSort, 
            ...
            <Navbar.Collapse id="responsive-navbar-nav">
                <Nav className="mr-auto">
                    <Button disabled={isAnimating()} onClick={generateArray} variant="primary">
                        <i className="fas fa-plus"></i> Generate New Array
                    </Button>
                    ...
                    <input
                        ...
                        onChange={e => getAnimationSpeed(e)}                            
                    />
