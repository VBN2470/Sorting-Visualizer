...
const SortingVisualizer = () => {
    ...
    const [ANIMATION_SPEED_MS, setAnimationSpeed] = useState(4);
    const [ARRAY_BARS, setArrayBars] = useState(200);
    ...
    const resetArray = () => {
        ...
        for (let i = 0; i < ARRAY_BARS; i++) {
            array.push(randomIntFromInterval(4, 480));
        }
        setArray(array);
    }
    ...
    return (
        <>
            ...
            getAnimationSpeed={e => getAnimationSpeed(e)}
